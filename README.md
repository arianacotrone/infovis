...
Este repositorio contiene la entrega final para el taller de **Visualización de Datos (2026) del ITBA**. El proyecto consiste en un dashboard web interactivo que analiza poco más de un año de actividad física personal, buscando entender la consistencia, las anomalías, el balance de las disciplinas y la optimización del rendimiento metabólico.
